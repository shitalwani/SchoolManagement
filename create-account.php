          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            ...
            <form action="" method="POST">
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  name="confirm_password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="***************"
                  type="password"
                />
              </label>
              ...
              <div class="flex mt-6 text-sm">
                <label class="flex items-center dark:text-gray-400">
                  <p style="color:red;"><?php echo $erroMsg; ?></p>
                </label>
              </div>

              <!-- You should use a button here, as the anchor is only used for the example  -->
              <input type="submit" name="submit" value="Create Account" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
               >
